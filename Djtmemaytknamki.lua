...
BhopSection:AddSlider("Bhop", "", 0, 1.3, 0.5, true, function(val)
    Bhop_Cooldown = tonumber(val);
end)

-- Alpha Skin Giver
MainSection:AddButton("Alpha Skin", "", function()
    Events.UI.Purchase:InvokeServer("Skins", "AlphaTester")
end)


MainSection:AddButton("Full Bright", "", function()
...
ESPSection:AddButton("Character", ".", function()
    ESP:ClearESP();
...
ESPSection:AddToggle("AI ESP", "memaybeo", false, function(bool)
    AI_ESP = bool;
end)
