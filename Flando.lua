...
do local GUI = game.CoreGui:FindFirstChild("Flando");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(242,243,243)
   end 
end
...
function Flando:ToggleUi()
if game.CoreGui:FindFirstChild("Flando").Enabled == true then 
game.CoreGui:FindFirstChild("Flando").Enabled = false
else
game.CoreGui:FindFirstChild("Flando").Enabled = true
end
end

function Flando:Window(text,gamenme,logo,keybind)
    local hubname = text
	...
	local Flando = Instance.new("ScreenGui")
	Flando.Name = "Flando" -- wait
	Flando.Parent = game.CoreGui
	Flando.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
